Feature: Assert an element is displayed or not displayed
  ...
  Scenario: Assert Test Text is (not) displayed
    Then "Big DIV" should be partially visible in the viewport
     And "All Centered 1" should be partially visible in the viewport
     And "All Centered 2" should be partially visible in the viewport
     And "All Centered 3" should be partially visible in the viewport
     And "All Centered 4" should be partially visible in the viewport
     ...
     And "Out to left" should not be partially visible in the viewport
     And "Out to right" should not be partially visible in the viewport
     And "Out to top" should not be partially visible in the viewport
     And "Out to bottom" should not be partially visible in the viewport
     And "Visible" should be partially visible in the viewport
     And "Invisible" should not be partially visible in the viewport
     And "Invisible 2" should not be partially visible in the viewport
     And "Visible 2" should not be partially visible in the viewport
  ...
  Scenario Outline: Throw an ExpectationException when a test fails
    ...
    Examples:
      ...
      | "Big DIV" should not be partially visible in the viewport        | Big DIV is partially visible in the viewport.           |
      | "All Centered 1" should not be partially visible in the viewport | All Centered 1 is partially visible in the viewport.    |
      | "All Centered 2" should not be partially visible in the viewport | All Centered 2 is partially visible in the viewport.    |
      | "All Centered 3" should not be partially visible in the viewport | All Centered 3 is partially visible in the viewport.    |
      | "All Centered 4" should not be partially visible in the viewport | All Centered 4 is partially visible in the viewport.    |
      | "Partial Left" should not be partially visible in the viewport   | Partial Left is partially visible in the viewport.      |
      | "Partial Right" should not be partially visible in the viewport  | Partial Right is partially visible in the viewport.     |
      | "Partial Top" should not be partially visible in the viewport    | Partial Top is partially visible in the viewport.       |
      | "Partial Bottom" should not be partially visible in the viewport | Partial Bottom is partially visible in the viewport.    |
      ...
      | "Visible" should not be partially visible in the viewport        | Visible is partially visible in the viewport.           |
